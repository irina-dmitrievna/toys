	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if (!isset($this->request->get['module_id'])) {
				$this->model_setting_module->addModule('aboutus', $this->request->post);
			} else {
		...
		if (!isset($this->request->get['module_id'])) {
			...
			$data['action'] = $this->url->link('extension/module/aboutus', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true);
		}
